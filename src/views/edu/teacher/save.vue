  ...
  data() {
    return {
      ...
      teacher: {
        sort: 0,
        level: 1,
        avatar: 'https://edu-hugh.oss-cn-shenzhen.aliyuncs.com/2020/10/19/6d6087250a2d409ca9c9d25a874853eeIMG_20200225_212932%20%283%29.jpg'
      },
  ...
  methods: {
    ...
    init() {
      ...
      if (this.$route.params && this.$route.params.id) {
        ...
        this.teacher = {avatar: 'https://edu-hugh.oss-cn-shenzhen.aliyuncs.com/2020/10/19/6d6087250a2d409ca9c9d25a874853eeIMG_20200225_212932 (3).jpg'};
      }
    },
    saveOrUpdate() {
      if (!this.teacher.id) {
